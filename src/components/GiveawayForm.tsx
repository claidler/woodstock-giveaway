...
interface GiveawayFormProps {
  ...
  onFormDataChange: (updater: (prev: GiveawayFormProps['formData']) => GiveawayFormProps['formData']) => void;
  onFormErrorChange: (updater: (prev: Record<string, boolean>) => Record<string, boolean>) => void;
  onSubmit: () => void;
  onReposition: () => void;
  onCancel: () => void;
}

export default function GiveawayForm({ formData, formErrors, onFormDataChange, onFormErrorChange, onSubmit, onReposition, onCancel }: GiveawayFormProps) {
